""" 
   ...
   Description: Parses am XML document, segmenting it into paragraphs, runs sklearn.LatentDirichletAllocation, gets the topics and top segements
   Status: WIP
   ToDo: ...
...
def main():
	...
	print("Score: " + str(lda.score(dt_matrix)/len(feature_names)))
